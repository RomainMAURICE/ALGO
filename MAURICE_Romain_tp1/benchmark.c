...
int run_single_test(int nb, int mode) {
    ...
    switch (nb) {
        ...
        case 6  : return test_random(nb, mode, 100, 1000, 200);
        case 7  : return test_random(nb, mode, 1000, 100000, 2000);
        case 8  : return test_random(nb, mode, 10000, 20000, 20000);
        case 9  : return test_random(nb, mode, 50000, 50000, 100000);
        case 10 : return test_random(nb, mode, 50000, 50000, 50);
        default :
          return 0;
    }
}
...
int test_random(int nb, int mode, int n_insert, int n_find, int modulo) {
    ...
    int msec;
    msec = total_ref*1000/CLOCKS_PER_SEC;
    printf("total time (reference): %d ms\n", msec);
    if (~mode & MODE_REFONLY) {
        msec = total*1000/CLOCKS_PER_SEC;
        printf("total time (student): %d ms\n", msec);
    }
